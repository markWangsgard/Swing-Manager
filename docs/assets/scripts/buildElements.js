...
export function buildFooter() {
    ...
    nowPlayingDivElement.classList = "flex flex-col items-center p-3 rounded rounded-2xl cursor-pointer"
    ...
    requestSongsDivElement.classList = "flex flex-col items-center p-3 rounded rounded-2xl cursor-pointer"
    ...
    requestSongsDivElement.addEventListener("click", () => {
        const currentUrl = new URL (window.location.href);
        const newPath = currentUrl.pathname.includes("docs") ? `/docs/request-songs.html` : `/request-songs.html;`
            currentUrl.pathname = newPath;
